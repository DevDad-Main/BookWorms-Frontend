...
@Component({
  ...
  styles: `.app-shell { display: flex; min-height: 100vh; }
    .sidebar { width: 260px; background: #181A1B; border-right: 1px solid rgba(255,255,255,0.04); display: flex; flex-direction: column; position: fixed; top: 0; left: 0; bottom: 0; z-index: 100; transition: transform 300ms cubic-bezier(0.4, 0, 0.2, 1); }
    .sidebar-header { padding: 20px; border-bottom: 1px solid rgba(255,255,255,0.04); }
    ...
    .brand-name { font-family: 'Playfair Display', Georgia, serif; font-size: 1.2rem; font-weight: 600; color: #F5F1E8; }
    .sidebar-nav { flex: 1; overflow-y: auto; padding: 16px 12px; display: flex; flex-direction: column; gap: 4px; }
    .nav-section { margin-bottom: 16px; }
    .nav-section-label { display: block; padding: 0 16px; margin-bottom: 6px; font-size: 0.7rem; font-weight: 600; color: #5C5750; text-transform: uppercase; letter-spacing: 0.08em; }
    .sidebar-overlay { display: none; }
    .main-area { flex: 1; margin-left: 260px; min-width: 0; display: flex; flex-direction: column; }
